...
some.php>>>
<?php
$template = new \Compermisos\Simple\Template("rute/to/archive.tpl");
...
class Template {
    ...
    */
     ...
     * @param string|integer $key the key to declare (replaced in template a [@tag]
